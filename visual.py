...
import sys
import pathlib
__file__='/home/henry/Desktop/Soft-DrQ-v2/train.py'
...
#########################################################################################################
def policy(time_step, sample = True, augmentation=0):
...
class reward:
    ...
    # action
    h = model_encoder(obs3).to('cuda') ## shape:[1,3886]; 3886 = 32 * 11 * 11 + 14 (14: orientations)
    dis = model_action(h, 0.1) ## 0.1 greedy
    action = dis.sample(clip = 0.3) ## sample
